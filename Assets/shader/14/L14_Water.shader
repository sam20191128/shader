Shader "AP01/L14/Water" //Shader路径名
{
    Properties //材质面板参数
    {
        ...
        Pass 
        {
            ...
            VertexOutput vert (VertexInput v) 
            {
                VertexOutput o = (VertexOutput)0;
                    ...
                    o.uv1 = v.uv * _Warp1Params.x - frac(_Time.x * _Warp1Params.yz);// 扰动1 Y：流速X Z：流速Y
                    o.uv2 = v.uv * _Warp2Params.x - frac(_Time.x * _Warp2Params.yz);// 扰动2 Y：流速X Z：流速Y
                return o;
            }
            // 输出结构>>>像素
