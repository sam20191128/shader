...
public class DOF_BokehBlur : PostEffectsBase
{
    public Shader bokehBlurShader;
    private Material bokehBlurMaterial = null;
    ...
    //散景模糊
    [Range(0.0f, 0.01f)] public float blurSize = 0.0004f; //模糊强度
    [Range(1, 50)] public int iterations = 50; //迭代次数
    [Range(1, 8)] public int RTDownSample = 2; //降采样次数
