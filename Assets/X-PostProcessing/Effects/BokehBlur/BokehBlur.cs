...
namespace XPostProcessing
{
    ...
    {
        [Range(0f, 3f)] public FloatParameter BlurRadius = new FloatParameter {value = 1f};

        [Range(8, 128)] public IntParameter Iteration = new IntParameter {value = 32};

        [Range(1, 10)] public FloatParameter RTDownScaling = new FloatParameter {value = 2};
    }
